...
class Articles extends Module {
  ...
  function getMenuItem($menu, $level = 0) {
    ...
    $values['actions_block'] = news_button::get('new_news', ModalForm::getLinkX('articles', 'add', $menu->get('id')), ' проект');
  ...
  static function get_admin_item($menu, $level = 0) {
    ...
    $values['actions_block'] = admin_button::get('edit', '/admin/admin.php?type=module_edit&module_name=articles&id=' . $menu->get('id'), ' статьи &quot;' . $menu->get('name') . '&quot;');
