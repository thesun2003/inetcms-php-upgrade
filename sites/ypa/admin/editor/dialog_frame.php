...
$url = 'dialog.php?dialog=wproCore_fileBrowser&action=link&chooser=true&dirs='.$type.'&'.(isset($editor->sess) ? $editor->sess->sessionName : 'wprosid').'='.(isset($editor->sess) ? $editor->sess->sessionId : '') . strip_tags('&'.session_name().'='.session_id()) . ($editor->appendToQueryStrings ? '&' . $editor->appendToQueryStrings : '');
