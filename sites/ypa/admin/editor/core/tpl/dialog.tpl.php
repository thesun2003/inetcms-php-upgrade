...
<script type="text/javascript" src="core/compileSharedJS.php?iframeDialogs=<?php echo ($EDITOR->iframeDialogs ? '1' : '0').'&amp;v='.$EDITOR->version ?>"></script>
<script type="text/javascript" src="core/compileCoreDialogJS.php?v=<?php echo $EDITOR->version ?>"></script>
<?php else : ?>
...
dialog.phpsid = '<?php echo addslashes(strip_tags(defined('SID') ? SID : '')) ?>';
