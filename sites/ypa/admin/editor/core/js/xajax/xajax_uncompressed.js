...
/*Array.prototype.xajaxContainsValue = function(valueToCheck)
{
...
function xajaxContainsValue(arr, valueToCheck) {
	...
	this.call = function(sFunction, aArgs, sRequestType)
	{
		...
		r.onreadystatechange = function()
		{
			...
			if (r.status==200)
			{
				...
				if (xajaxContainsValue(xajax.responseErrorsForAlert, r.status)) {
