...
var url = this.URL + 'dialog.php?dialog=' + url + '&' + this.sid + (this.phpsid ? '&' + this.phpsid : '') + (this.appendToQueryStrings ? '&' + this.appendToQueryStrings : '');
...
var locationRegex = new RegExp('^'+this.quoteMeta(this._location.replace(/&/gi,'(&|&amp;)'))+'#', 'gi');
...
var domainRegex = new RegExp('^'+this.quoteMeta(loc) +'[^\/]*(|/)', 'gi');
