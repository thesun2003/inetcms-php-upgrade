...
if (a=CELL.style.backgroundColor||currentEditor.strict) {
if (color!='') {
...
} else if (a=CELL.getAttribute('bgColor') && color == '') {
CELL.removeAttribute('bgColor');
} else if (color!='') {
...
if (a=CELL.style.backgroundImage||currentEditor.strict) {
if (image!='') {
...
} else if (a=CELL.getAttribute('background') && image == '') {
CELL.removeAttribute('background');
} else if (image!='') {
...
if (a=ROW.style.backgroundColor||currentEditor.strict) {
if (color!='') {
...
} else if (a=ROW.getAttribute('bgColor') && color == '') {
ROW.removeAttribute('bgColor');
} else if (color!='') {
...
} else if (a=TABLE.getAttribute('width') && width == '') {
...
if (form.tableHeight) {
if (a=TABLE.style.height||currentEditor.strict) {
if (height!='') {
...
} else if (a=TABLE.getAttribute('height') && height == '') {
TABLE.removeAttribute('height');
} else if (height!='') {
...
if (a=TABLE.style.cssFloat||currentEditor.strict) {
...
if (a=TABLE.style.backgroundColor||currentEditor.strict) {
if (color!='') {
...
} else if (a=TABLE.getAttribute('bgColor') && color == '') {
TABLE.removeAttribute('bgColor');
} else if (color!='') {
...
if (a=TABLE.style.backgroundImage||currentEditor.strict) {
if (image!='') {
...
TABLE.removeAttribute('bgColor');
} else if (a=TABLE.getAttribute('background') && image == '') {
...
if (form.tableCaptionAlign) {
var align = '';
if (a=c.item(0).style.captionSide||currentEditor.strict) {
