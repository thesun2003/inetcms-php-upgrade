...
var na = currentEditor.editDocument.createElement('A');
na.innerHTML = text;
...
if (links[i].getAttribute('href').search('WPRO_TEMP_LINK_') != -1) {
a.push(links[i]);
}
}
}
...
if (doAppend) a[l-1].parentNode.insertBefore(append, a[l-1].nextSibling);
}
