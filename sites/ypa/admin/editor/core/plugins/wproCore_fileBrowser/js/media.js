...
node = range.nodes[0];
var data = node.getAttribute('_wpro_media_data');
...
currentEditor.insertImage(location+'core/images/placeholder.gif', {'width':width,'height':height,'style':istyle,'class':'wproFilePlugin'+className,'hspace':hspace,'vspace':vspace,'border':border,'align':align,'title':title,'alt':alt,'_wpro_media_data':mediaData}, style);
}