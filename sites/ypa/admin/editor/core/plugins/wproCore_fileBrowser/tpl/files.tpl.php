...
<div <?php if (in_array($file['name'], $highlight)) : echo 'class="selected" '; endif;?>title="<?php echo htmlspecialchars($file['name']) ?>; <?php echo htmlspecialchars($file['size']) ?>; <?php echo htmlspecialchars(isset($file['dimensions']['text'])?$file['dimensions']['text']:'') ?>; <?php echo htmlspecialchars($langEngine->date($file['modified'])) ?>" onclick="FB.selectFile(this,{'name':'<?php echo addslashes(htmlspecialchars($file['name'])) ?>','type':'<?php echo addslashes(htmlspecialchars($langEngine->get('files', $file['type']))) ?>','size':'<?php echo addslashes(htmlspecialchars($file['size'])) ?>','mod':'<?php echo addslashes(htmlspecialchars($langEngine->date($file['modified']))) ?>','prev':<?php echo htmlspecialchars($file['info']['preview']) ?>})" ondblclick="this.onclick();setTimeout('formAction();',100)" oncontextmenu="FB.inContext=true;this.onclick();return false;">
...
<!-- display files -->
<?php foreach ($files as $file) : if ($i < $pageStart) {$i++;continue;} ?>
<tr <?php if (in_array($file['name'], $highlight)) : echo 'class="selected" '; endif;?>onclick="FB.selectFile(this,{'name':'<?php echo addslashes(htmlspecialchars($file['name'])) ?>','type':'<?php echo addslashes(htmlspecialchars($langEngine->get('files',$file['type']))) ?>','size':'<?php echo addslashes(htmlspecialchars($file['size'])) ?>','mod':'<?php echo addslashes(htmlspecialchars($langEngine->date($file['modified']))) ?>','prev':<?php echo htmlspecialchars($file['info']['preview']) ?>})" title="<?php echo htmlspecialchars($file['name']) ?>" ondblclick="this.onclick();setTimeout('formAction();',100)" oncontextmenu="FB.inContext=true;this.onclick();return false;">
...
<td nowrap="nowrap"><?php echo $langEngine->get('files', $file['type']) ?>&nbsp;&nbsp;</td>
