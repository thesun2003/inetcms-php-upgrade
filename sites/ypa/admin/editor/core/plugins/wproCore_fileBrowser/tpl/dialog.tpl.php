...
document.write('<div class="leftColumn"><iframe class="outlookBar inset" id="outlookFrame" name="outlookFrame" src="dialog.php?dialog=wproCore_fileBrowser&action=outlook&amp;current=<?php echo htmlspecialchars($chooserType); ?>&amp;mode=<?php echo htmlspecialchars($chooserType); ?><?php echo ($EDITOR->appendToQueryStrings ? '&amp;'.$EDITOR->appendToQueryStrings : '') ?>&amp;<?php echo htmlspecialchars($wpsname); ?>=<?php echo htmlspecialchars($wpsid); ?><?php echo strip_tags(defined('SID') ? '&amp;'.SID : ''); ?>&amp;properties=true#<?php echo htmlspecialchars($action); ?>" frameborder="0"></iframe></div>');


} else {

document.write('<div class="leftColumn"><iframe class="outlookBar inset" id="outlookFrame" name="outlookFrame" src="dialog.php?dialog=wproCore_fileBrowser&action=outlook&amp;current=<?php echo htmlspecialchars($chooserType); ?>&amp;mode=<?php echo htmlspecialchars($chooserType); ?><?php echo ($EDITOR->appendToQueryStrings ? '&amp;'.$EDITOR->appendToQueryStrings : '') ?>&amp;<?php echo htmlspecialchars($wpsname); ?>=<?php echo htmlspecialchars($wpsid); ?><?php echo strip_tags(defined('SID') ? '&amp;'.SID : ''); ?><?php echo $chooser ? '&amp;chooser=true' :'' ?>#<?php echo htmlspecialchars($action); ?>" frameborder="0"></iframe></div>');
...
<div id="sitePreviewHolder"><iframe class="previewFrame" id="sitePreview" name="sitePreview" src="dialog.php?dialog=wproCore_fileBrowser&action=preview<?php echo ($EDITOR->appendToQueryStrings ? '&amp;'.$EDITOR->appendToQueryStrings : '') ?>&amp;<?php echo htmlspecialchars($wpsname); ?>=<?php echo htmlspecialchars($wpsid); ?><?php echo strip_tags(defined('SID') ? '&amp;'.SID : ''); ?>" frameborder="0"></iframe>
...
<iframe class="previewFrame" id="webPreview" name="webPreview" src="dialog.php?dialog=wproCore_fileBrowser&action=preview<?php echo ($EDITOR->appendToQueryStrings ? '&amp;'.$EDITOR->appendToQueryStrings : '') ?>&amp;<?php echo htmlspecialchars($wpsname); ?>=<?php echo htmlspecialchars($wpsid); ?><?php echo strip_tags(defined('SID') ? '&amp;'.SID : ''); ?>" frameborder="0"></iframe>
...
<iframe id="filePanePreview" name="filePanePreview" class="previewFrame" src="dialog.php?dialog=wproCore_fileBrowser&action=preview<?php echo ($EDITOR->appendToQueryStrings ? '&amp;'.$EDITOR->appendToQueryStrings : '') ?>&amp;<?php echo htmlspecialchars($wpsname); ?>=<?php echo htmlspecialchars($wpsid); ?><?php echo strip_tags(defined('SID') ? '&amp;'.SID : ''); ?>" frameborder="0"></iframe>
