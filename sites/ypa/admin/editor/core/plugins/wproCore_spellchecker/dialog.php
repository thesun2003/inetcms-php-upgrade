...
class wproDialogPlugin_wproCore_spellchecker {
	function init (&$DIALOG) {
		...
		//} else {
			$DIALOG->template->assign('spellcheckerURL', 'core/plugins/wproCore_spellchecker/checkSpelling.php?'.$wpsname.'='.$sid.($EDITOR->appendToQueryStrings ? '&'.$EDITOR->appendToQueryStrings : '').strip_tags(defined('SID') ? '&'.SID : ''));
		//}
