...
<iframe src="core/plugins/wproCore_spellchecker/blank.php?<?php echo $wpsname?>=<?php echo $sid?><?php echo ($EDITOR->appendToQueryStrings ? '&amp;'.$EDITOR->appendToQueryStrings : '') ?><?php echo strip_tags(defined('SID') ? '&amp;'.SID : ''); ?>" name="spellcheckerResultsFrame_<?php echo htmlspecialchars($rand); ?>" id="spellcheckerResultsFrame_<?php echo htmlspecialchars($rand); ?>"></iframe>
</fieldset>
