...
var e;
if (objectPlugin) {
objectPluginData = currentEditor.plugins['wproCore_fileBrowser'].unserializeMedia(SELECTED_TAG.getAttribute("_wpro_media_data"), 'source');
var d, x;
...
if (title) SELECTED_TAG.setAttribute('_wpro_media_data', title);
