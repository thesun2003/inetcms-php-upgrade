...
define('IMAGE_FILE_DIRECTORY', 'z:/home/djai.ru/www/pic/pages/');
...
define('IMAGE_WEB_DIRECTORY', '/pic/pages/');
...
define('DOCUMENT_FILE_DIRECTORY', dirname(dirname(__FILE__)).'/i/media/');
...
define('DOCUMENT_WEB_DIRECTORY', '/i/media/');
