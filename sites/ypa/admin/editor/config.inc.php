...
define('WPRO_EDITOR_URL', 'http://acyparu.bizhosting.ru/admin/editor/');
...
if (!defined('WPRO_DIR')) define('WPRO_DIR', '/usr/home/acyparu/domains/ac-ypa.ru/public_html/admin/editor/');  
