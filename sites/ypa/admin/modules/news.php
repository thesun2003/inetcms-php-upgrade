...
<table class="table2" cellspacing="5">
  ...
  <tr>
    ...
    <input type="button" value="�������" onclick="window.open('simg.php','mywin','height=500,width=500,scrollbars')" />
    </td>
  </tr>
  <tr>
...
<?php editor('content', ''); ?>
  ...
  <tr>
    <td>�����:</td>
    <td><input type="checkbox" name="anons" id="anons" onchange="switch_off('top');" /> <i>(���������� ��� �����)</i></td>
  </tr>
  <tr>
    <td>���������:</td>
    <td><input type="checkbox" name="top" id="top" onchange="switch_off('anons');" /> <i>(���������� �������� �� ��������� � ���� ������)</i></td>
  </tr>
...
<?php
	if (!empty($row['img']) && glob('../i/intro/'.$row['img'])) {
		...
		echo '<input type="checkbox" name="delimg" /> - ������� ��������<br clear="all" />';
	}
?>
...
?>
  ...
  <tr>
    <td>�����:</td>
    <td><input type="checkbox" name="anons"<?=$anons?>  id="anons" onchange="switch_off('top');" /> <i>(���������� ��� �����)</i></td>
  </tr>
  <tr>
    <td>���������:</td>
    <td><input type="checkbox" name="top"<?=$top?>  id="top" onchange="switch_off('anons');" /> <i>(���������� �������� �� ��������� � ���� ������)</i></td>
  </tr>
...
<?php
	...
	if ($_GET['act'] == 'list') {
		if ($_GET['cat'] == 'news') {
			echo '<center>�������� ��������� �� <form style="display:inline" method="post" name="pageform">';
